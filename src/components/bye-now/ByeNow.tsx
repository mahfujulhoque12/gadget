  ...
  return (
    ...
    <MaxWidthWrapper>
      <div className="my-10 max-w-2xl mx-auto bg-white p-6 rounded-lg shadow-md border border-gray-300">
        <h2 className="text-2xl font-bold mb-4 text-center text-green-900">Buy Your Gadget</h2>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={isLoading}
              className="relative overflow-hidden text-xl font-bold text-white bg-black px-6 py-3 rounded-md w-full block text-center group"
          >
